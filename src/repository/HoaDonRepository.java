...
public class HoaDonRepository {
    ...
    public List<HoaDonChiTiet> getHD() {
        ...
        try {
            String sql = "select a.mahd,tenkh,d.Ten,ngaytao,TongTien,a.TienCanTra,TienKhachDua,TienThua,a.TRANGTHAI\n"
            ...
            while (rs.next()) {
                ...
                b.setTongTien(rs.getBigDecimal(5));
                b.setTienCanTra(rs.getBigDecimal(6));
                b.setTienKhachDua(rs.getBigDecimal(7));
                b.setTIenThua(rs.getBigDecimal(8));
                b.setTrangThai(rs.getInt(9));
