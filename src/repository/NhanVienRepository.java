...
public class NhanVienRepository {
    ...
    public Integer addNhanVien(NhanVien nhanVien) {
        ...
        try {
            Connection con = DBConnection.getConnection();
            String sql = "INSERT INTO nhanvien(manv,tennv,gioitinh,email,quequan,ngaysinh,taikhoan,matkhau,trangthai) values (?,?,?,?,?,?,?,?,?)";
            ...
            ps.setDate(6, (Date) nhanVien.getNgaySinh());
            ps.setString(7, nhanVien.getTaiKhoan());
            ps.setString(8, nhanVien.getMatKhau());
            ps.setInt(9, nhanVien.getTrangThai());
...
//    }
    ...
    public Integer updateNhanVien(NhanVien nhanVien) {
        ...
        try {
            Connection con = DBConnection.getConnection();
            String sql = "UPDATE nhanvien SET tennv=?, gioitinh=?, email=?, quequan=?, ngaysinh=?, taikhoan=?, matkhau=?, trangthai=? WHERE manv=? ";
            PreparedStatement ps = con.prepareStatement(sql);
            ...
            ps.setDate(5, (Date) nhanVien.getNgaySinh());
